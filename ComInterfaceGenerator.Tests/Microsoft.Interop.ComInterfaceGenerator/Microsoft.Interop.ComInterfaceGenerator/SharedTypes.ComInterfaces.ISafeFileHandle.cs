...
file unsafe partial interface InterfaceImplementation : global::SharedTypes.ComInterfaces.ISafeFileHandle
{
    ...
    {
        var(__this, __vtable_native) = ((global::System.Runtime.InteropServices.Marshalling.IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(global::SharedTypes.ComInterfaces.ISafeFileHandle));
    ...
    void global::SharedTypes.ComInterfaces.ISafeFileHandle.MethodOut(out global::Microsoft.Win32.SafeHandles.SafeFileHandle p)
    {
        ...
        global::System.Runtime.CompilerServices.Unsafe.SkipInit(out p);
        nint __p_native = default;
        int __invokeRetVal = default;
        // Setup - Perform required setup.
