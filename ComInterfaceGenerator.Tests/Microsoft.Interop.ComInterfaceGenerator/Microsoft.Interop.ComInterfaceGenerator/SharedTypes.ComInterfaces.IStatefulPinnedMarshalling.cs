...
file unsafe partial interface InterfaceImplementation : global::SharedTypes.ComInterfaces.IStatefulPinnedMarshalling
{
    ...
    {
        var(__this, __vtable_native) = ((global::System.Runtime.InteropServices.Marshalling.IUnmanagedVirtualMethodTableProvider)this).GetVirtualMethodTableInfoForKey(typeof(global::SharedTypes.ComInterfaces.IStatefulPinnedMarshalling));
...
file unsafe partial interface InterfaceImplementation
{
    ...
    internal static int ABI_Method(global::System.Runtime.InteropServices.ComWrappers.ComInterfaceDispatch* __this_native, nint __param_native)
    {
        ...
        try
        {
            ...
            // Unmarshal - Convert native data to managed data.
            param = __param_native__marshaller.ToManaged();
            @this = global::System.Runtime.InteropServices.ComWrappers.ComInterfaceDispatch.GetInstance<global::SharedTypes.ComInterfaces.IStatefulPinnedMarshalling>(__this_native);
            @this.Method(param);
            // NotifyForSuccessfulInvoke - Keep alive any managed objects that need to stay alive across the call.
            __retVal = 0; // S_OK
        }
...
file unsafe partial interface InterfaceImplementation
{
    ...
    {
        void** vtable = (void**)global::System.Runtime.CompilerServices.RuntimeHelpers.AllocateTypeAssociatedMemory(typeof(global::SharedTypes.ComInterfaces.IStatefulPinnedMarshalling), sizeof(void*) * 9);
        {
            nint v0, v1, v2;
