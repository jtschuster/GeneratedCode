...
file sealed unsafe class ComClassInformation : global::System.Runtime.InteropServices.Marshalling.IComExposedClass
{
    ...
    public static global::System.Runtime.InteropServices.ComWrappers.ComInterfaceEntry* GetComInterfaceEntries(out int count)
    {
        ...
        if (s_vtables == null)
        {
            ...
            details = global::System.Runtime.InteropServices.Marshalling.StrategyBasedComWrappers.DefaultIUnknownInterfaceDetailsStrategy.GetIUnknownDerivedDetails(typeof(SharedTypes.ComInterfaces.IUTF8Marshalling).TypeHandle);
            vtables[0] = new()
            {
                IID = details.Iid,
...
namespace ComInterfaceGenerator.Tests
{
    public unsafe partial class StringMarshallingTests
    {
        ...
        internal partial class Utf8MarshalledClass
        {
        }
    }
}
