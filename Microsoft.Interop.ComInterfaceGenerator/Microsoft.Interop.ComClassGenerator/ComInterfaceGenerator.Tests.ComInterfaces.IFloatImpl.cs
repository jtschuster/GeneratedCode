...
file sealed unsafe class ComClassInformation : System.Runtime.InteropServices.Marshalling.IComExposedClass
{
    ...
    public static System.Runtime.InteropServices.ComWrappers.ComInterfaceEntry* GetComInterfaceEntries(out int count)
    {
        ...
        if (s_vtables == null)
        {
            ...
            details = System.Runtime.InteropServices.Marshalling.StrategyBasedComWrappers.DefaultIUnknownInterfaceDetailsStrategy.GetIUnknownDerivedDetails(typeof(ComInterfaceGenerator.Tests.ComInterfaces.IFloat).TypeHandle);
            vtables[0] = new()
            {
                IID = details.Iid,
